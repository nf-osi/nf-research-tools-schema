...
#### 1. Create Synapse Personal Access Token
...
4. Name: `SYNAPSE_AUTH_TOKEN`
5. Value: Paste the Synapse token you copied
6. Click **Add secret**

#### 3. Enable Workflow

The workflow is now ready! It will run automatically every Monday at 9 AM UTC.
