...
_The date that the resource was originally added._
...
URI: [nftools:dateAdded](https://w3id.org/nf-research-tools/dateAdded)
...
| ---  | ---  |
| self | nftools:dateAdded |
| native | nftools:dateAdded |
