...
_Size in bp of the backbone without the insert._
...
URI: [nftools:backboneSize](https://w3id.org/nf-research-tools/backboneSize)
...
| ---  | ---  |
| self | nftools:backboneSize |
| native | nftools:backboneSize |
