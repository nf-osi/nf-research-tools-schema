...
# Slot: 5primeCloningSite 


_If Restriction Enzyme was selected as the cloning method, the enzyme used on the 5' (N-terminal) end._
...
URI: [nftools:5primeCloningSite](https://w3id.org/nf-research-tools/5primeCloningSite)
...
| ---  | ---  |
| self | nftools:5primeCloningSite |
| native | nftools:5primeCloningSite |
