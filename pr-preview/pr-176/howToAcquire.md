...
_How to acquire a particular resource._
...
URI: [nftools:howToAcquire](https://w3id.org/nf-research-tools/howToAcquire)
...
| ---  | ---  |
| self | nftools:howToAcquire |
| native | nftools:howToAcquire |
